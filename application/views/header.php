	<div class="navbar navbar-legalisir navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" style="margin-top:0px ;padding-top:0px;margin-bottom: 0px;padding-bottom: 0px;" href="<?php echo base_url()?>"><img src="<?php echo base_url('images/itb-lamb.png')?>" style="height:50px;margin: 0px;padding: 0px" /> Aplikasi Legalisir Ijazah SITH </a>
        </div>
